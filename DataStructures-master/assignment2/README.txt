...
We worked together as partners on this assignment. 

No known errors. Runs well on Karl’s machine. 

RUN golMain.cpp for the working code and look at that file when grading. NOT IMPLEMENTATION. 

Source files submitted: golMain.cpp
